...
#define LM_RGUI LM(_RAISE, MOD_LGUI)
#define KanaGUI LGUI(KC_LANG1)
#define EisuGUI LGUI(KC_LANG2)
...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL , KC_APP , KC_LALT , KC_LGUI , TT_LOWER , EisuGUI , KC_SPC  , KC_SPC  , KanaGUI , TT_RAISE , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT \
),
[_LOWER] = LAYOUT( \
  ...
  _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_LBRC , KC_RBRC , _______ , KC_PIPE , \
...
[_RAISE] = LAYOUT( \
  ...
  _______ , KC_F7   , KC_F8   , KC_F9   , KC_F10  , KC_F11  , KC_F12  , _______ , _______ , _______ , KC_LCBR , KC_RCBR , _______ , KC_BSLS , \
